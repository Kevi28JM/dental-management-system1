...
import "@/styles/AssistDentistList.css"; // Import your CSS file

 function AssistDentistList() {
  ...
  const handleChannel = (dentistId) => {
    ...
    const targetUrl = `/AssistViewAvailability?dentistId=${dentistId}`;
...
export default AssistDentistList;